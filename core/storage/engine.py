...
def get_user_config(username: str = None, bypass_cache: bool = False) -> dict:
    ...
    # Load configuration directly from local storage for performance and quota safety
...
def read_database_rows(table_key: str, username: str = None, bypass_cache: bool = False) -> list:
    ...
    # Load database rows directly from local Excel storage for performance and quota safety
